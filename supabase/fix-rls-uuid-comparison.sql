-- ============================================================================
-- CRITICAL FIX: Normalize RLS auth.uid() comparisons by actual column type
-- ============================================================================
-- ERROR: "operator does not exist: uuid = text"
-- CAUSE: RLS policies were comparing UUID columns to text fields or using unsafe casts.
-- SOLUTION:
--   - Compare uuid columns directly to auth.uid() when auth.uid() returns uuid.
--   - Cast text columns (like tasks.user_id or messages.sender_id) to auth.uid()::text.
--
